...
public sealed class BesJwtOptions
{
    public const string SectionName = "BesJwt";
...
public sealed class BesJwtTokenService : IDisposable
{
    ...
    private readonly BesJwtOptions _options;
    ...
    public BesJwtTokenService(IOptions<BesJwtOptions> options, ModuleManifest manifest)
    {
    ...
    private string ResolveKeyPath()
    {
        ...
        var tls = Environment.GetEnvironmentVariable("MODULE_TLS_DATA_PATH")
            ...
            ?? "data/mtls";
        return Path.Combine(tls, "bes-jwt-rsa.pem");
    }

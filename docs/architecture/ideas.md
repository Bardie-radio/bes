...
**Ops:** Bes final image is Alpine (`aspnet:10.0-alpine3.22`) — META-OPS-002 / [bes#10](https://github.com/Bardie-radio/bes/issues/10) / [kithara#33](https://github.com/Bardie-radio/kithara/issues/33). Logging quieting lands with next GHCR publish ([pre-publish-audit](https://github.com/Bardie-radio/kithara/blob/main/docs/architecture/mvp/pre-publish-audit.md)).
